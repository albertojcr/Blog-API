import {showNewUserModal} from "./user/table.js";
import {showNewPostModal} from "./post/table.js";
import {renderAdminPanelSection, renderMyPostsSection, showLoginModal, logout} from "../app.js";

export function renderNavbarButtons(session) {
...
function createLogoutButton() {
    let button = document.createElement('li');
    button.innerHTML = `<a class="dropdown-item text-danger" href="/home">
...
function createAdminPanelButton() {
    let button = document.createElement('li');
    button.innerHTML = `<a class="dropdown-item" href="admin-panel.php">
...
function createMyPostsButton() {
    let button = document.createElement('li');
    button.innerHTML = `<a class="dropdown-item" href="my-posts.php">
